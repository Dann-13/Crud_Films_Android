package com.example.aplicacionpelis.casos_uso;
...
import com.example.aplicacionpelis.vista.EdicionPeliculaActivity;
import com.example.aplicacionpelis.vista.VistaPeliculaActivity;

public class CasosUsoPelicula {
    private Activity activity;
    private PeliculasBD peliculas;
    private AdaptadorPeliculasDB adaptador;
    public CasosUsoPelicula(Activity activity, PeliculasBD peliculas, AdaptadorPeliculasDB adaptador)//constructor para ir a vista pelicula
    {
    ...
    public void borrar(final int id) {
        new AlertDialog.Builder(activity)
                .setTitle("Borrado de pelicula")
                .setMessage("¿Seguro de eliminar esta pelicula?")
